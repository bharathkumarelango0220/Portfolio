...
export const metadata: Metadata = {
  title: 'Trip Tools — Travel Companion & Trip Expense Tracker — Product Case Study | Bharathkumar E',
  description:
    'Comprehensive product showcase and architecture of Trip Tools travel companion and 6-category trip expense tracker, built by Bharathkumar E.',
};

export default function TripToolsProductPage() {
  const architecturalHighlights = [
    {
      title: 'GPS Google Maps Integration',
      description: 'One-click deep links and integrated geographic coordinates for top tourist destinations and attractions with distance calculation and opening hours.',
      icon: MapPin,
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
              <div className="lg:col-span-8 space-y-4">
                ...
                <p className="text-base sm:text-lg text-muted-foreground leading-relaxed max-w-3xl">
                  A high-utility travel companion web application built to streamline trip sightseeing 
                  and group travel expense management. Deployed live at{' '}
                  <a 
              ...
              <div className="lg:col-span-4 grid grid-cols-2 gap-3">
                ...
                <div className="glass-panel p-4 rounded-2xl border border-border/80 text-center">
                  <div className="text-2xl font-serif font-bold text-blue-500">GPS</div>
                  <div className="text-xs text-muted-foreground font-medium mt-1">Live Navigation</div>
                </div>
                <div className="glass-panel p-4 rounded-2xl border border-border/80 text-center">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6">
              <div>
                ...
                <p className="text-sm text-muted-foreground">Test the live Trip Tools application in real-time below.</p>
              </div>
              <a
                href="https://triptools.vercel.app/"
                target="_blank"
            ...
            <div className="w-full h-[620px] rounded-3xl overflow-hidden glass-panel border border-border shadow-2xl relative">
              <iframe
                ...
                title="Trip Tools Web Application"
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="max-w-3xl mb-12 space-y-3">
              ...
              <p className="text-muted-foreground text-sm sm:text-base">
                Discover the architectural decisions, tools, and algorithms that make Trip Tools fast, dependable, and easy to use.
              </p>
            </div>
            ...
            <div className="glass-panel p-8 rounded-3xl border border-border/80 flex flex-col md:flex-row items-center justify-between gap-6">
              <div className="space-y-2 text-center md:text-left">
                <h3 className="font-serif text-xl sm:text-2xl font-bold text-foreground">
                  Want a custom web product like Trip Tools built for your business?
                </h3>
              ...
              <div className="flex items-center gap-3">
                ...
                <a
                  href="https://wa.me/918220802736?text=Hi%20Bharathkumar,%20I%20saw%20Trip%20Tools%20and%20want%20to%20build%20a%20similar%20product!"
                  target="_blank"
                  rel="noopener noreferrer"
