  ...
  return (
    <div className="md:hidden fixed bottom-3 inset-x-0 z-40 px-4 pointer-events-none">
      <div className="max-w-md mx-auto glass-panel rounded-2xl p-1.5 shadow-2xl border border-white/20 dark:border-white/10 pointer-events-auto flex items-center justify-around">
        ...
        <Link
          href="/"
          className="flex flex-col items-center justify-center p-2 rounded-xl text-muted-foreground hover:text-primary active:scale-95 transition-all group"
        >
        ...
        <Link
          href="/#brief-wizard"
          className="flex flex-col items-center justify-center px-3 py-1.5 rounded-xl bg-primary text-white shadow-md shadow-primary/30 active:scale-95 transition-all"
        >
